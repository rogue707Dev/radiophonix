@servers(['prod' => 'runcloud@137.74.196.193', 'local' => '127.0.0.1'])

@setup
    // Dossier racine
    $app_dir = '/home/runcloud/webapps/production';

    // Dossier contenant les releases
    $releases_dir = '/home/runcloud/webapps/production/releases';

    // Dossier contenant les dossiers/fichiers partagés
    $shared_dir = '/home/runcloud/webapps/production/shared';
...
@task('create_release_dir', ['on' => 'prod'])
