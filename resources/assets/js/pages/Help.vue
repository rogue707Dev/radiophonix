<template>
    <div class="layout-conteneur__main">
        ...
        <h2 class="titre--bloc mb-4">Liste Saga</h2>
            ...
            <li>
                <a href="/ecouter/sagas/le-donjon-de-naheulbeuk" class="">
                    <div class="jaquette--grande jaquette--saga zone-interactive__border">
                        <img src="/static/dev/images/media/1462912999/conversions/main.jpg" alt="" width="340px" height="340px">
                    </div>
        ...
        <h2 class="titre--bloc mb-4">Résultat recherche</h2>
                            ...
                            <div class="zone-interactive__border d-flex">
                                <div class="flex-grow-1">
                                    <div class="jaquette--moyen jaquette--faiseur">
                                        <img src="/static/dev/images/media/1277011276/conversions/thumb.jpg" alt="" width="340px" height="340px">
                                    </div>
                                </div>
                            </div>
                            <div class="zone-interactive border-top-0">
                            ...
                            <div class="zone-interactive__border d-flex">
                                <div class="flex-grow-1">
                                    <div class="jaquette--moyen jaquette--episode">
                                        <img src="/static/dev/images/media/1753359144/conversions/thumb.jpg" alt="" width="340px" height="340px">
                                    </div>
                                </div>
                            </div>
                            <div class="zone-interactive border-top-0">
                            ...
                            <div class="zone-interactive__border d-flex">
                                <div class="flex-grow-1">
                                    <div class="jaquette--moyen jaquette--genre">
                                        <img src="/static/dev/images/media/1581834270/conversions/main.jpg" alt="" width="340px" height="340px">
                                    </div>
                                </div>
                            </div>
                            <div class="zone-interactive border-top-0">
                                    ...
                                    <div class="d-flex">
                                        <div class="liste-resultat__visuel">
                                            <div class="jaquette--petite jaquette--saga">
                                                <img src="/static/dev/images/media/1462912999/conversions/thumb.jpg" alt="" height="340px" width="340px">
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="liste-resultat__visuel">
                                            <div class="jaquette--petite jaquette--faiseur">
                                                <img src="/static/dev/images/media/1277011276/conversions/thumb.jpg" alt="" height="340px" width="340px">
                                            </div>
                                        </div>
                                        <div class="liste-resultat__info">
                                            <p class="titre-resultat-recherche">Pen Of Chaos</p>
                                    ...
                                    <div class="d-flex">
                                        <div class="liste-resultat__visuel">
                                            <div class="jaquette--petite jaquette--episode">
                                                <img src="/static/dev/images/media/1753359144/conversions/thumb.jpg" alt="" height="340px" width="340px">
                                            </div>
                                        </div>
                                        <div class="liste-resultat__info">
                                            <p class="titre-resultat-recherche">Présentation</p>
                                    ...
                                    <div class="d-flex">
                                        <div class="liste-resultat__visuel">
                                            <div class="jaquette--petite jaquette--genre">
                                                <img src="/static/dev/images/media/1581834270/conversions/main.jpg" alt="" height="340px" width="340px">
                                            </div>
                                        </div>
                                        <div class="liste-resultat__info">
                                            <p class="titre-resultat-recherche">Heroic fantasy</p>
        ...
        <div class="row mb-5">
            <div class="col-6">
                <h2 class="titre--bloc mb-4">Bouton</h2>
                <div>
                ...
                <h2 class="titre--bloc mb-4 mt-5">Habillage FA</h2>
                ...
                <h2 class="titre--bloc mb-4 mt-5">Taille</h2>
                ...
                <h2 class="titre--bloc mb-4 mt-5">Graisse</h2>
            ...
            <div class="col-6">
                ...
                <h2 class="titre--bloc mb-4">Espacement bs</h2>
                <div>Texte</div>
                <div>Texte</div>
                <div>Texte</div>
                <div>Texte</div>
                ...
                <h2 class="titre--bloc mb-4 mt-5">Cartouche</h2>
                <ul class="reset-ul">
                    <li class="cartouche">
                ...
                <h2 class="titre--bloc mb-4 mt-5">Icon cc dans banniere</h2>
                <div class="banniere__icon-cc">
                    <i class="cc cc-BY"></i>
                </div>

                <h2 class="titre--bloc mb-4 mt-5">Navigation</h2>
                <ul class="navigation">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <h2 class="titre--bloc mt-5 mb-4">Notification</h2>
                <button type="button" class="btn btn-primary">
                    Notifications <span class="badge badge-light">4</span>
                </button>


                <h2 class="titre--bloc mt-5 mb-4">Contextual variations</h2>
                ...
                <h2 class="titre--bloc mt-5 mb-4">Pill badges</h2>
                ...
                <h2 class="titre--bloc mt-5 mb-4">Links</h2>
            ...
            <div class="col-6">
                ...
                <h2 class="titre--bloc mt-5 mb-4">Bouton</h2>
                ...
                <h2 class="titre--bloc mt-5 mb-4">Outline buttons</h2>
                ...
                <h2 class="titre--bloc mt-5 mb-4">Sizes</h2>
                ...
                <h2 class="titre--bloc mt-5 mb-4">Active state</h2>
                <a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Primary link</a>
                <a href="#" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Link</a>

                <h2 class="titre--bloc mt-5 mb-4">Disabled state</h2>
