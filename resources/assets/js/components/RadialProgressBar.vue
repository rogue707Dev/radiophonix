<template>
    <div class="radial-progress-container" :style="containerStyle" @click="seek">
...
export default {
    ...
    methods: {
        seek(event) {
            ...
            let distanceFromCenter = function(x, y, center) {
            ...
            let percentage = Math.round(angle * 100 / 360);

            let distance = distanceFromCenter(x, y, center);

            if (distance >= 90 && distance <= 120) {
                this.$store.dispatch('player/seek', percentage);
            }
        },
        ...
        gotoPoint () {
            ...
            this.gradient.fx = point.x || 0
            this.gradient.fy = point.y || 0
        },
